...
// and the bare alias) with strict matching — the host resolves this migrated
// component through the generated field-renderer component map keyed by the
// binding ids (@cinatra-ai/email-follow-up-agent:follow-up-cadence and
// @cinatra-ai/email-drafting-agent:follow-up-cadence). The condition + kind
// floor stay host-side (register-default-renderers.ts).
...
export default FollowUpCadenceFieldRenderer;
